...
$con = new mysqli("localhost","root","","insurance");
    if($con->connect_error) {
        ...
        $sql2 = "SELECT * FROM addplan WHERE id = '$_GET[id]' ";
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePlans" class="collapse" aria-labelledby="headingPlans"
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Claim Insurance</h1>

                    <form class="user" action="addClaim.php" method="POST">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h4 mb-0 text-primary"><?php echo $row2['plan']; ?></h1>
                        </div>

                        <div class="form-group row">
                        <div class="col-sm-12 mb-3">
                                <h6 class="m-0 font-weight-bold text-primary">Policy Holder</h6>
                            ...
                            <div class="col-sm-6 mb-3">
                                <h6 class="m-0 font-weight-bold text-primary">Incident Location</h6>
                                <input type="text" name="location" class="form-control form-control-range"
                                    id="exampleInputNumber" aria-describedby="numberHelp"
                                    placeholder="Where Did It Happened?">
                            </div>
                            <div class="col-sm-6 mb-3">
                                <h6 class="m-0 font-weight-bold text-primary">Incident Time</h6>
                                <input type="time" name="time" class="form-control form-control-range"
                                    id="exampleInputNumber" aria-describedby="numberHelp"
                                    placeholder="When Did It Happened?">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <h6 class="m-0 font-weight-bold text-primary">Damage Extent</h6>
                                <textarea name="damage" class="form-control form-control-range"
                                    id="exampleInputStartDate" placeholder="Tell Us About The Extent of The Damage"></textarea>
                            </div>
                        </div>

                        <input class="btn btn-primary btn-block" type="Submit" value="Request" name="">
                    </form>
