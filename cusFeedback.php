        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form class="user" action="addFeedback.php" method="POST">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h4 mb-0 text-primary">Feedback Form</h1>
                        </div>

                        <div class="form-group row">
                            <div class="col-sm-12 mb-3 ">
                                <h6 class="m-0 font-weight-bold text-primary">Tell Us How You Feel About This Website</h6>
                                <textarea name="feedback" class="form-control form-control-range" 
                                id="exampleInputUsername" aria-describedby="usernameHelp"
                                placeholder="Tell Us What Happened"></textarea>
                            </div>
                        </div>
    
                        <input class="btn btn-primary btn-block" type="Submit" value="Send Feedback" name="">
                    </form>
