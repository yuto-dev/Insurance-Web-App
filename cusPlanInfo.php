        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"><?php echo $row2['plan']; ?></h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <h6 class="m-0 font-weight-bold text-black-50"><?php echo $row2['description']; ?></h6>
                        </div>
                    </div>   
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <h6 class="m-0 font-weight-bold text-black-50"><?php echo $row2['detail']; ?></h6>
                        </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <h6 class="h3 font-weight-bold text-black-50"><?php echo $row2['Price']; ?> Monthly</h6>
                                </div>
                                <div class="col-sm-2">    
